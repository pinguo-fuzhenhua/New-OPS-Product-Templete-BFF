...
require (
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20220107141547-76ab0baa561f
	...
	github.com/pinguo-icc/operational-positions-svc v0.0.0-20220218025758-70842058e450
